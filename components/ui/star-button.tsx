...
export function StarButton({
  ...
  return (
    <button
      ...
      ref={pathRef}
      className={cn(
        "relative z-[3] overflow-hidden h-9 px-4 py-2 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 group/star-button",
        className,
      )}
      {...props}
    >
      ...
      <div
        ...
        style={{ borderWidth: "var(--border-width)", borderStyle: "solid", borderColor: "rgba(20,184,166,0.3)" }}
        aria-hidden="true"
      >
        <StarBackground color="rgba(20,184,166,0.08)" />
      </div>
      <span className="z-10 relative flex items-center gap-1.5 text-foreground/80">
        {children}
      </span>
    </button>
  );
